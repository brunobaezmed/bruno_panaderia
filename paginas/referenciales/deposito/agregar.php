<div class="container-fluid card" style="padding: 30px;">
    <div class="row g-3">
        ...
        <div class="col-md-8">
            <label for="deposito_nombre" class="form-label">Nombre del Depósito *</label>
        ...
        <div class="col-md-12">
            ...
            <textarea id="deposito_ubicacion" class="form-control" rows="3" placeholder="Ubicación o descripción del depósito"></textarea>
        </div>
