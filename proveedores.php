<?php
// Página independiente para listar proveedores (renderizado por servidor)
...
<div class="container-fluid card" style="padding: 30px;">
    <div class="row">
        <div class="col-md-8">
            <h3>Lista de Proveedores (Página independiente)</h3>
        </div>
        <div class="col-md-4 text-end">
            <button class="btn btn-primary" onclick="/* abrir formulario agregar proveedor via JS si existe */; return false;"><i class="fa fa-plus"></i> Agregar</button>
        </div>
        <div class="col-md-12">
            <hr>
        </div>
